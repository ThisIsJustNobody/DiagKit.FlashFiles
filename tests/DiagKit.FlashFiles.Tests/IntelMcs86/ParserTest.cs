...
public class ParserTest
{
    ...
    public void ReadAt_已知地址_返回正确数据()
    {
        ...
        Assert.AreEqual(0x8A, data[0], "字节 0 不匹配。");
        Assert.AreEqual(0x42, data[1], "字节 1 不匹配。");
    }
    ...
    public void ReadRange_跨地址范围_返回正确数据()
    {
        ...
        CollectionAssert.AreEqual(new byte[] { 0x00, 0x56, 0x00, 0x78 }, data.ToArray());
    }
